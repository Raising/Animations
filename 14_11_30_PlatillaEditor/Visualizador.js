...
$(document).ready(function() {
	...
	for(var fun in ARM.Text.In ){
		$("<button id='"+fun+"' class='function'>"+fun+"</button>").click(
				function(auxFun){return function(){	ARM.Text.In[auxFun](frameSelected,5);	};			
	...
	for(var fun in ARM.Text.Mid){
		$("<button id='"+fun+"' class='function'>"+fun+"</button>").click(
				function(auxFun){return function(){ARM.Text.Mid[auxFun](frameSelected,5);	};			
		}(fun)).appendTo($("#Texto-Mantenido"));	

	}
	for(var fun in ARM.Text.Out){
		$("<button id='"+fun+"' class='function'>"+fun+"</button>").click(
				function(auxFun){return function(){	ARM.Text.Out[auxFun](frameSelected,5);};			
		}(fun)).appendTo($("#Texto-Salida"));		

	}
	for(var fun in ARM.Group.In ){
		$("<button id='"+fun+"' class='function'>"+fun+"</button>").click(
				function(auxFun){return function(){	ARM.Group.In[auxFun](frameSelected,5);	};			
		}(fun)).appendTo($("#Grupal-Entrada"));	

	}
	for(var fun in ARM.Group.Mid ){
		$("<button id='"+fun+"' class='function'>"+fun+"</button>").click(
				function(auxFun){return function(){	ARM.Group.Mid[auxFun](frameSelected,5);	};			
		}(fun)).appendTo($("#Grupal-Mantenido"));	

	}
	for(var fun in ARM.Group.Out ){
		$("<button id='"+fun+"' class='function'>"+fun+"</button>").click(
				function(auxFun){return function(){	ARM.Group.Out[auxFun](frameSelected,5);	};			
		}(fun)).appendTo($("#Grupal-Salida"));	

	}
	for(var fun in ARM.Container.In ){
		$("<button id='"+fun+"' class='function'>"+fun+"</button>").click(
				function(auxFun){return function(){	ARM.Container.In[auxFun](frameSelected,5);	};			
	...
	for(var fun in ARM.Container.Mid ){
		console.log(fun);
		$("<button id='"+fun+"' class='function'>"+fun+"</button>").click(
				function(auxFun){return function(){	ARM.Container.Mid[auxFun](frameSelected,5);	};			
		}(fun)).appendTo($("#Contenedor-Mantenido"));	

	}
	for(var fun in ARM.Container.Out ){
		$("<button id='"+fun+"' class='function'>"+fun+"</button>").click(
				function(auxFun){return function(){	ARM.Container.Out[auxFun](frameSelected,5);	};			
