...
+'  width: 100%;\n'
+'  height: 100%;\n'
+'	  perspective:'+((interactor.creator.perspectiveHandler.progress()*2900)+100)+'px;\n'
+'\n'
+'}\n'
...
for (var i = 0; i < interactor.divCreated.length;i++){
	...
	+' -webkit-transform: translateZ('+stats.positionZ+'px) rotateZ('+stats.rotationZ+'deg) rotateY('+stats.rotationY+'deg)  rotateX('+stats.rotationX +'deg);\n'
	+' transform:translateZ('+stats.positionZ+'px) rotateZ('+stats.rotationZ+'deg) rotateY('+stats.rotationY+'deg)  rotateX('+stats.rotationX +'deg);\n'
	+' z-index: 0;\n'
